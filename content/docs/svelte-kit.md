...
Download a model file from [https://huggingface.co/ggerganov/whisper.cpp/tree/main](https://huggingface.co/ggerganov/whisper.cpp/tree/main) and place it in your static folder. eg. `/static/ggml-tiny-q5_1.bin` .
